  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        disabled={currentPage === 1 || condition}
...
export const PagePagination = ({
  ...
  return (
    <div className="flex items-center gap-2">
      <button
        type="button"
        className="flex items-center justify-center w-10 h-10 rounded-lg border border-gray-300 bg-white disabled:opacity-50 disabled:cursor-not-allowed"
        onClick={() => onPageChange(Math.max(1, currentPage - 1))}
