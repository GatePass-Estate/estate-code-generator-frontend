...
const CodeCard = ({
  ...
  return (
    <div className="flex relative ">
      <div
        className={`border p-7 rounded-lg flex flex-col gap-4 z-10 ${styles.container} ${styles.text}`}
      >
      ...
      <div
        className={`${styles.action} relative -left-8 pl-10 p-2 rounded-xl gap-5 flex flex-col h-fit`}
      >
