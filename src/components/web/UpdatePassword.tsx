...
const UpdatePassword = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      >
        <div
          className="cursor-pointer absolute right-4 top-4 sm:right-6 sm:top-6"
          onClick={() => setShowUpdatePassword(false)}
        >
          <Image
            source={icons.cancel}
        ...
        <h4
          className={`${isLargeScreen ? "text-4xl" : "text-2xl"} font-UbuntuSans font-normal mb-2 text-black text-center`}
        >
          New Password
        </h4>
