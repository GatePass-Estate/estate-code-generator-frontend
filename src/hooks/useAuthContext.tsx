...
const PUBLIC_AUTH_ROUTES = ['/activate', '/auth/set-password', '/auth/email-activation-status', '/auth/login', '/auth/forgot-password', '/auth/reset-password', '/auth/tos', '/auth/data-protection-policy', '/', 'contact', 'terms-of-service', 'privacy-policy', 'about'];
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
	...
	useEffect(() => {
		...
		const isPublicRoute = (currentPath: string, initialURL: string | null): boolean => {
			return PUBLIC_AUTH_ROUTES.some((r) => currentPath === r || currentPath.startsWith(r) || (initialURL && initialURL.includes(r)));
		};
