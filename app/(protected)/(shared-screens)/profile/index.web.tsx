  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="relative">
        ...
        >
          <Image
            source={show ? icons.eye : icons.hiddenEye}
            ...
            <div className="flex flex-col justify-center mt-20">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <p
                      className={`italic text-sm font-medium ${
                        expiring ? "text-tertiary" : "text-primary"
                      }`}
                    >
              ...
              <div className="mb-8 p-8 rounded-lg border border-[#CEE5ED] bg-[#f3fcfa] flex flex-col gap-4">
                {[
                  {
                    label: "Name",
                    value: `${useUserStore.getState().first_name} ${
      ...
      {showUpdatePassword && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="bg-white rounded-lg p-8 py-16 pt-32 z-10 min-w-[450px] relative">
            <div
              className="cursor-pointer absolute right-6 -mt-16"
              onClick={() => setShowUpdatePassword(false)}
            >
              <Image
                source={icons.cancel}
            ...
            {success && (
              <div className="text-green-500 font-medium my-4 p-3 bg-green-500/20 rounded">
                {success}
              </div>
            )}

            <h4 className="text-4xl font-UbuntuSans font-normal mb-2 text-black text-center">
              New Password
            </h4>
              ...
              <WebPasswordInput
                ...
                onChange={(v) => {
                  if (confirmPasswordRef.current)
                    confirmPasswordRef.current.value = v;
                }}
                show={showConfirm}
            ...
            <div className="flex justify-center gap-3">
              <button
                className={`full-btn !px-16 ${savingPassword && "opacity-65"}`}
