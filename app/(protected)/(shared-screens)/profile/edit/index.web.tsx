			...
			<div className="web-body">
				<div className="flex flex-col justify-center mt-20">
					<div>
						...
						<p className="text-base text-tertiary mt-1">Send a request to edit your personal details</p>
					</div>
					...
					<form className="py-7 flex flex-col gap-6 min-w-[400px]  md:min-w-[500px] lg:min-w-[600px]">
						...
						<div className="self-end flex gap-4">
							<button onClick={() => router.push('/profile')} type="button" className="text-primary font-medium py-3 px-14 cursor-pointer">
								Cancel Request
							</button>
