    ...
    <SafeAreaView style={sharedStyles.container}>
      ...
      >
        <View className="gap-4 mb-12">
          <Text className="text-4xl font-UbuntuSans text-primary text-center">
            Verify incoming {'\n'} guest’s code
          </Text>
        ...
        <Pressable
          className={`bg-primary py-5 px-20 rounded-lg self-center mt-20 ${isSubmitting && 'opacity-70'}`}
          onPress={handleValidation}
          disabled={isSubmitting}
        >
          <Text className="text-white font-Roboto font-bold text-[16px]">
