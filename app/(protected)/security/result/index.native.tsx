...
export default function ValidationResult() {
  ...
  const relationship_with_resident = String(
    params.relationship_with_resident || "",
  );
  ...
  return (
    <SafeAreaView style={[sharedStyles.container, sharedStyles.modalContainer]}>
      ...
      <ScrollView
        contentContainerClassName="px-2 pt-16 pb-10"
        ...
        {!isError ? (
          <>
            ...
            {receiver === "visitor" && (
              <>
                <Text
                  className={`text-sm font-inter-semibold mb-3 mt-5 ${styles.text}`}
                >
                  GUEST DETAILS
                </Text>
                <View
                ...
                >
                  <SingleDetail
                    ...
                    value={
                      visitor_fullname
                        ? visitor_fullname.charAt(0).toUpperCase() +
                          visitor_fullname.slice(1)
                        : ""
                    }
                  />
            ...
            <Text className="text-sm font-inter-semibold mb-3 text-teal">
              RESIDENT DETAILS
            </Text>
            <View
