		...
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.inputRow}>
				{code.map((digit, index) => (
					// <TextInput key={index} ref={(ref) => (inputs.current[index] = ref)} style={styles.inputBox} maxLength={1} keyboardType="default" onChangeText={(text) => handleChange(text, index)} value={digit} />
					<></>
				))}
			</View>
