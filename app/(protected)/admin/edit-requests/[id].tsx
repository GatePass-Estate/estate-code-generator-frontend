...
export default function EditRequestDetailPage() {
	return (
		<View className="flex-1 bg-page px-6 pt-6">
			{/* Header */}
			<View className="mb-6">
				<Text className="text-text-primary text-2xl font-semibold">Edit Request</Text>
				<Text className="text-text-secondary text-sm mt-1">Review requested profile change</Text>
			</View>
			...
			<View className="bg-card border border-border rounded-xl p-5 mb-8">
				...
				<Text className="text-text-primary font-medium">{MOCK_REQUEST.name}</Text>

				<Text className="text-text-muted text-xs uppercase mt-4 mb-1">Field</Text>
			...
			<View className="flex-row gap-6 mb-8">
				...
				<View className="flex-1 border border-border rounded-xl p-5">
					...
					<Text className="text-text-primary font-medium">{MOCK_REQUEST.before}</Text>
				</View>
				...
				<View className="flex-1 border border-border rounded-xl p-5 bg-highlight">
					...
					<Text className="text-text-primary font-medium">{MOCK_REQUEST.after}</Text>
				</View>
			</View>
