        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingTop: 40 }}>
          <View className="flex-1 mb-8">
            ...
            <View className="bg-light-grey p-4 rounded-lg border border-grey/50">
              <SingleDetail
                label={getFieldLabelFromType(requestData.request_type)}
                value={requestData.old_value}
                contentColor="text-grey"
              />
            </View>
          </View>

          <View className="flex-1 mb-8">
            <Text className="text-lg font-ubuntu-semibold text-primary mb-4">
              Requested New Value
            </Text>
            <View className="bg-light-teal p-4 rounded-lg border border-teal/40">
              <SingleDetail
                label={getFieldLabelFromType(requestData.request_type)}
                value={requestData.new_value || 'N/A'}
              />
            </View>
          </View>
