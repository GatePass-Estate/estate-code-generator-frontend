...
const EditRequestMobile = () => {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error ? error.message : 'An error occurred while approving requests';
      setToastMessage(errorMessage);
      setToastType('error');
      setToastVisible(true);
    } finally {
  ...
  const handleDecline = async () => {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error ? error.message : 'An error occurred while declining requests';
      setToastMessage(errorMessage);
      setToastType('error');
      setToastVisible(true);
    } finally {
        ...
        <View className="flex-row gap-3 mt-8">
          ...
          >
            {processingAction === 'decline' ? (
              ...
              <Text className="text-white font-ubuntu-semibold text-md">Decline</Text>
            )}
          </TouchableOpacity>
          ...
          >
            {processingAction === 'approve' ? (
              ...
              <Text className="text-white font-ubuntu-semibold text-md">Approve</Text>
            )}
          </TouchableOpacity>
        </View>
      )}
