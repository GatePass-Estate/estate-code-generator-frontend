...
export default function AdminUsersPage() {
	return (
		<View className="min-h-screen bg-[#F9FAFB] px-10 py-8">
			{/* Header */}
			<View className="mb-8">
				<Text className="text-[22px] font-semibold text-[#111827]">All Users</Text>
			</View>
			...
			<View className="mb-8 grid grid-cols-3 gap-6">
				<View className="rounded-lg border border-[#E5E7EB] bg-white px-6 py-5">
					...
					<Text className="mt-2 text-2xl font-semibold text-[#111827]">245</Text>
				</View>

				<View className="rounded-lg border border-[#E5E7EB] bg-white px-6 py-5">
					<Text className="text-sm text-[#6B7280]">Security Personnel</Text>
					<Text className="mt-2 text-2xl font-semibold text-[#111827]">178</Text>
				</View>

				<View className="rounded-lg border border-[#E5E7EB] bg-white px-6 py-5">
					<Text className="text-sm text-[#6B7280]">Total Users</Text>
					<Text className="mt-2 text-2xl font-semibold text-[#111827]">423</Text>
				</View>
			</View>
			...
			<View className="rounded-lg border border-[#E5E7EB] bg-white">
				...
				{[
					...
					<View key={idx} className="grid grid-cols-6 items-center border-b border-[#F1F5F9] px-6 py-4 text-sm text-[#111827]">
						<Text>{user.name}</Text>
