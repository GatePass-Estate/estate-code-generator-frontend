        ...
        <View className="w-[320px] bg-white border-r border-[#E5E7EB] p-8 h-full">
            ...
            <View>
              {POLICY_SECTIONS.map((section) => (
                ...
                >
                  ...
                  <Text
                    className={`font-UbuntuSans text-sm ${activeSection === section.id ? 'text-primary font-bold' : 'text-[#4B5563]'}`}
                    numberOfLines={1}
                  >
                    {section.title}
                  </Text>
          ...
          >
            <Text className="font-UbuntuSans text-sm text-black">
              {fromSettings ? 'Back' : 'Back to Terms'}
            </Text>
          </Pressable>
        </View>
      ...
      >
        ...
        <View className="bg-[#F8F8F8] rounded-xl p-6">
          {POLICY_SECTIONS.map((section, index) => (
            ...
            >
              <Text className="font-UbuntuSans text-xl text-black font-semibold mb-1">
                {section.title}
              </Text>
              {section.content ? (
                <Text className="font-Inter text-sm text-[#4B5563] leading-6">
                  {section.content}
                </Text>
              ) : null}
              ...
              {section.subSections &&
                section.subSections.map((sub, sIdx) => (
                  <View key={sIdx} className="ml-2">
                    <Text className="font-UbuntuSans text-base text-black font-medium mb">
                      {sub.title}
                    </Text>
                    {sub.content && (
                      <Text className="font-Inter text-sm text-[#4B5563] leading-6 mb-1">
                        {sub.content}
                      </Text>
                    )}
                    {sub.bullets && (
