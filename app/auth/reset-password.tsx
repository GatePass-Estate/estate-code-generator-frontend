...
export default function ResetPassword() {
  ...
  useEffect(() => {
    const verify = async () => {
      ...
      const token =
        params.token ||
        (Platform.OS === 'web' ? new URLSearchParams(window.location.search).get('token') : null);
        ...
        <View className="gap-4 max-w-xl">
          ...
          <View>
            ...
            <View className="relative">
              ...
              >
                <Image
                  source={showNewPassword ? icons.eye : icons.hiddenEye}
          ...
          <View>
            ...
            <View className="relative">
              ...
              >
                <Image
                  source={showConfirmPassword ? icons.eye : icons.hiddenEye}
                  style={{ width: 20, height: 20 }}
                  resizeMode="contain"
                />
              </Pressable>
